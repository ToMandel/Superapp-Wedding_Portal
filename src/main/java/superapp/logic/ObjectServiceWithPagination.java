...
public interface ObjectServiceWithPagination extends RelationshipObjectsService {
	...
	public List<SuperAppObjectBoundary> searchObjectsByLocation(String userSuperApp, String email,double lat, double lng, double distance,
			String distanceUnits, int size, int page);

	public List<SuperAppObjectBoundary> searchObjectsByType (String type, int size, int page, String userSuperApp,  String email);

	public List<SuperAppObjectBoundary> searchObjectsByAlias (String type, int size, int page, String userSuperApp, String email);
